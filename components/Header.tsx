...
const handlePopoverOpenChange = (open: boolean) => {
  ...
  return (
    ...
    <header className="app-header h-20">
      ...
      <div 
  className={`header-brand ${location.pathname === "/" || location.pathname === "/prelogin" || location.pathname === "/reset-password" || location.pathname === "/new-password" ? 'cursor-default' : 'cursor-pointer'}`} 
  onClick={async () => {
    // Don't navigate if on login, prelogin, reset-password, or new-password pages
    if (location.pathname === "/" || location.pathname === "/prelogin" || location.pathname === "/reset-password" || location.pathname === "/new-password") {
      console.log("Logo clicked on restricted page - staying on current page");
      return;
    }
  ...
  <img src={oxfordIgniteLogo} alt="Oxford Ignite" className="h-11 w-auto" />
      ...
      <div className="flex items-right gap-2 md:gap-4">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          {pageType === "default" && isAgreeTermsAndCondition !== 0 && location.pathname !== "/reset-password" && location.pathname !== "/new-password" && (
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="outline"
        ...
        {pageType !== "login" && pageType !== "prelogin" && location.pathname !== "/reset-password" && location.pathname !== "/new-password" && (
          <DropdownMenu>
