          ...
          <iframe 
            ...
            onLoad={async (e) => {
              ...
              try {
                ...
                const iframeApiBaseUrl = await getApiBaseUrl();
                const progressUrl = `${iframeApiBaseUrl}/api/UserProgress/search?userId=${encodeURIComponent(userId)}&courseAssetId=${encodeURIComponent(courseAssetId)}&csAssetId=0&isRecentBrowse=false&courseId=0`;
                ...
                const iframeUpdateApiBaseUrl = await getApiBaseUrl();
                const updateResponse = await fetch(`${iframeUpdateApiBaseUrl}/api/UserProgress/update`, {
                  method: 'POST',
                  headers: {
                    'Content-Type': 'application/json',
                  },
