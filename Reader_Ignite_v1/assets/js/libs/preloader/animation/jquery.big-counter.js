...
;(function ($) {
	...
	$.fn.extend({
		...
		var defaults = {
				...
				font:               "normal 100px Arial", /* set preloader font (you can embed a font by css and use it here) */
			...
			*/
			...
			var draw = function () {
				var width = canvasWidth,
					...
					var LoaderProgressVal = (self.currentPercentage - 100)*3;

					$("#DvLoaderProgress").css("left", LoaderProgressVal+"px");
				...
				//ctx.fillText("Loading..."+(self.currentPercentage| 0) + "%", positionX - 8, positionY - 15);
			...
			*/
			...
			// 		$container.delay(10).fadeOut(function(){
			// 			$container.remove();
			...
			*/
			...
			self.init = function () {			
				...
				$("#DvLoaderCont").css("display", "block");	
			};
			self.update = function ( prercentage ) {				
				$("#DvLoaderProgressBgText").html("Loading:"+prercentage+"%");				
				$.Animation(self, {
